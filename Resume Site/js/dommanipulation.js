...
// Hint: Use getElementById and change the textContent
document.getElementById("about-text").textContent = "We are a company deticated to creating web experinces.";
